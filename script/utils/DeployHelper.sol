...
abstract contract DeployHelper {
    mapping(string => DeployConfig) public deployConfigs;
    ...
    constructor() {
        ...
        DeployConfig storage config = deployConfigs["EthereumSepolia"];
        ...
        config = deployConfigs["AvalancheFuji"];
        ...
        config = deployConfigs["OPSepolia"];
        config.tokenMessenger = 0x9f3B8679c73C2Fef8b59B4f3444d4e156fb70AA5;
        config.localMinter = 0xE997d7d2F6E065a9A93Fa2175E878Fb9081F1f0A;
        ...
        config = deployConfigs["ArbitrumSepolia"];
        config.tokenMessenger = 0x9f3B8679c73C2Fef8b59B4f3444d4e156fb70AA5;
        config.localMinter = 0xE997d7d2F6E065a9A93Fa2175E878Fb9081F1f0A;
        ...
        config = deployConfigs["BaseSepolia"];
        config.tokenMessenger = 0x9f3B8679c73C2Fef8b59B4f3444d4e156fb70AA5;
        config.localMinter = 0xE997d7d2F6E065a9A93Fa2175E878Fb9081F1f0A;
        ...
        config = deployConfigs["PolygonPoSAmoy"];
        config.tokenMessenger = 0x9f3B8679c73C2Fef8b59B4f3444d4e156fb70AA5;
        config.localMinter = 0xE997d7d2F6E065a9A93Fa2175E878Fb9081F1f0A;
    ...
    ) public view returns (DeployConfig memory) {
        DeployConfig memory config = deployConfigs[chainName];
